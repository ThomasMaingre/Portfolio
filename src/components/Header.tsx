...
export default function Header() {
  ...
  const menuItems = [
    ...
    { href: "/cv/ThomasMaingre.pdf", label: "CV", target: "_blank" },
  ];

  return (
    <>
      <header
        className={`fixed top-0 left-0 w-full flex justify-between items-center p-4 transition-colors duration-300 ${
          scroll ? 'bg-gray-800 text-white' : 'bg-transparent text-black'
        }`}
        style={{ zIndex: 1000 }}
      >
