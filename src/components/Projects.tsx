  ...
  const projects: Project[] = [
    {
      ...
      presentation: "OhPets est une application mobile développée avec Symfony pour le back-end et React pour le front-end, destinée aux propriétaires cherchant à retrouver leurs animaux perdus. En tant que chef de projet, j’ai dirigé l’équipe et supervisé l’intégration des fonctionnalités.",
      objectif: "Faciliter la localisation des animaux perdus grâce à une carte interactive et une bibliothèque d’animaux détaillée via une API, augmentant les chances de les retrouver rapidement.",
      conclusion: "OhPets offre une solution efficace pour retrouver les animaux égarés. Ce projet m’a permis de développer des compétences en gestion d'équipe et coordination de développement.",
