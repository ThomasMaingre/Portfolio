                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    <div className="md:w-1/2 text-white">
                        <p className="mb-4 text-xl font-bold">
                            Thomas, 27 ans – <span style={{ color: '#fad62b ' }}>Développeur et Intégrateur Web</span>
                        </p>

                        <br></br>

                        <p>
                            Ancien boulanger de métier, j'ai dû entreprendre une reconversion professionnelle suite à une maladie liée à mon travail. Cette transition m'a permis de découvrir ma passion pour le développement web. Actuellement en formation BAC+3 à Nexa Digital School, je me spécialise dans le développement et l'intégration web.
                            <br></br>
                            <br></br>
